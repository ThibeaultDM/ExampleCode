    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerException", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonAddress", x => new { x.AddressesId, x.PeopleId });
                    table.ForeignKey(
                        name: "FK_PersonAddress_Address_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonAddress_Customer_PeopleId",
                        column: x => x.PeopleId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CreditInfo_Customers_Id",
                        column: x => x.Id,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyAddress", x => new { x.AddressesId, x.CompaniesId });
                    table.ForeignKey(
                        name: "FK_CompanyAddress_Address_AddressesId",
                        column: x => x.AddressesId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyAddress_Company_CompaniesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceHeaderProxy", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceHeaderProxy_Company_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyAddress_CompaniesId",
                table: "CompanyAddress",
                column: "CompaniesId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditInfo_Id",
                table: "CreditInfo",
                column: "Id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHeaderProxy_CompanyId",
